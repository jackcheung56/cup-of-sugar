    ...
    <div className="browsePage">
      <div className="browsePageTop">
        ...
        <div className="catButtons">
          ...
          <button className="btns" onClick={sortAppliances}>
            appliances
          </button>
          <button className="btns" onClick={sortFitness}>
            fitness
          </button>
          <button className="btns" onClick={sortClothing}>
            clothing
          </button>
          <button className="btns" onClick={sortEntertainment}>
            entertainment
          </button>
          <button className="btns" onClick={sortBooks}>
            books
          </button>
          <button className="btns" onClick={sortTools}>
            tools
          </button>
          <button className="btns" onClick={sortInstruments}>
            instruments
          </button>
          <button className="btns" onClick={sortPantry}>
            pantry
          </button>
        </div>
      ...
      <div className="itemList">
        {browseItems.map((item, idx) => (
          <ItemCard
            ...
            onClick={() =>
              props.history.push(`/items/${item.id}`, (item = { item }))
            }
